...
urlpatterns = [
  ...
  path('fetchlastworkspace', wv.fetch_last_created_workspace, name='last-workspace'),
  path('fetchoneworkspace/<str:encrypted_workspace_id>', wv.fetch_one_workspace, name='one-workspace'),
